...
from util.project_paths import JIRA_DATASET_ISSUES, JIRA_DATASET_JQLS, JIRA_DATASET_KANBAN_BOARDS, \
    JIRA_DATASET_PROJECTS, JIRA_DATASET_SCRUM_BOARDS, JIRA_DATASET_USERS, JIRA_DATASET_CUSTOM_FIELDS
import json
...
def jira_datasets():
    ...
    data_sets["custom_fields"] = read_input_file(JIRA_DATASET_CUSTOM_FIELDS)
    page_size = 25
