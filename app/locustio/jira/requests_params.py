...
from util.project_paths import JIRA_DATASET_ISSUES, JIRA_DATASET_JQLS, JIRA_DATASET_KANBAN_BOARDS, \
    JIRA_DATASET_PROJECTS, JIRA_DATASET_SCRUM_BOARDS, JIRA_DATASET_USERS, JIRA_DATASET_ORGANIZATION
import json
...
def jira_datasets():
    ...
    data_sets["organizations"] = read_input_file(JIRA_DATASET_ORGANIZATION)
    page_size = 25
