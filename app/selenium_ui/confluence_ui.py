...
"""
def test_1_selenium_view_advanced_image_gallery(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.test_1_view_advanced_image_gallery_config(confluence_webdriver, confluence_datasets)
