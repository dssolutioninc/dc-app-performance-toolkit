...
"""
def test_1_selenium_view_meetical_for_confluence(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.test_1_view_meetical_for_confluence(confluence_webdriver, confluence_datasets)
