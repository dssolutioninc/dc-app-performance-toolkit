...
"""
def test_1_selenium_view_page_with_advanced_tabs(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.test_1_view_page_with_advanced_tabs(confluence_webdriver, confluence_datasets)
