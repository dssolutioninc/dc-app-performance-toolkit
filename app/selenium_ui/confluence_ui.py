...
"""
def test_1_selenium_advanced_collaborative_table_updater(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.test_1_view_advanced_collaborative_table_updater(confluence_webdriver, confluence_datasets)
