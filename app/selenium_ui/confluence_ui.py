...
"""
def test_1_selenium_status_macro_configuration(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.test_1_view_status_macro_configuration(confluence_webdriver, confluence_datasets)
