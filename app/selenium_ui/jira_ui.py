...
def test_1_selenium_view_project_role_tab(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.test_1_view_project_role_tab(jira_webdriver, jira_datasets)
