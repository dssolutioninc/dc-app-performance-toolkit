...
def test_1_selenium_view_version_manager(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.test_1_view_version_manager(jira_webdriver, jira_datasets)
