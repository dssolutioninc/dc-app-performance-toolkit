...
class UrlManager:
    ...
    def __init__(self, issue_key=None, issue_id=None, project_key=None, jql=None, projects_list_page=None,
        ...
        self.project_page_cl_params = f"/projects/{project_key}?selectedItem=selectedItem=com.appbox.ai.checklist:checklist-project-sidebar"   
    ...
    def project_page_cl_url(self):
        return f"{self.host}{self.project_page_cl_params}"
...
class ProjectLocators:
    ...
    project_page_cl_content = (By.CLASS_NAME, "aui-page-panel")
