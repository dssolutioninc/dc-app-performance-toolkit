...
class UrlManager:
    ...
    def __init__(self, page_id=None):
        ...
        self.page_with_advanced_table_formatting_params = "/display/ATFT/Test+1"
    ...
    def page_with_advanced_table_formatting_url(self):
        return f"{self.host}{self.page_with_advanced_table_formatting_params}"
