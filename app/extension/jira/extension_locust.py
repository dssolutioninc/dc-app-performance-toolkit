...
def project_role_tab(locust):
    ...
    # get group member
    r = locust.get(f'/rest/projectrole/1.0/projectrole/10002/{project_key}/groupmember?groupname=jira-administrators', catch_response=True)  # call app-specific GET endpoint //fix project role & groupname
