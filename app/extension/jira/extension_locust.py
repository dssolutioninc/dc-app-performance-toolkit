...
def project_role_tab(locust):
    ...
    # get group member
    r = locust.get('/rest/projectrole/1.0/projectrole/10002/PT/groupmember?groupname=jira-administrators', catch_response=True)  # call app-specific GET endpoint //fix groupname
